  ...
  return (
    <Card>
      ...
      <div style={{ marginBottom: "var(--space-4)" }}>
        ...
        {is2v2 ? (
          <p className="callout">
            <Icons.IconFrozen size={17} /> <strong>Freeze-Regel:</strong>{" "}
            Geworfen wird alternierend (T1 → T2 → T1 → T2). Ein Team gewinnt bei
            0 Rest nur, wenn die eigenen Teampunkte ≤ den Gegnerpunkten sind!
          </p>
        ) : (
          <Slider
            name="playerCount"
      ...
      >
        {Array.from({ length: 4 }).map((_, i) => {
          ...
          const isBot = isGuest
            ? guestBots[playerName]
            : profiles[playerName]?.isBot;
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: is2v2
                      ? slotColor
                      : playerColorByName(playerName || `Gast ${i + 1}`),
                  }}
                >
                  {isBot ? (
                    <Icons.IconBot size={17} />
                  ) : (
                  ...
                  >
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          lineup.toggleGuestBot(i, e.target.checked)
                        }
      ...
      >
        ...
        {!lineup.randomOrderOnStart && (
          <div style={{ display: "flex", justifyContent: "center" }}>
            ...
            >
              <Icons.IconOneTimeShuffle size={16} /> Jetzt einmalig mischen
            </Button>
          </div>
        )}
      </div>
